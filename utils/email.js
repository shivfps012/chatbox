...
const sendMockEmail = (email, resetToken, userName) => {
...
const sendPasswordResetEmail = async (email, resetToken, userName) => {
  ...
  if (!process.env.EMAIL_HOST || !process.env.EMAIL_USER || !process.env.EMAIL_PASS || !process.env.EMAIL_FROM) {
    console.log('⚠️ Email configuration incomplete, using mock email for testing');
    return sendMockEmail(email, resetToken, userName);
  }
  ...
  try {
    ...
    // Fallback to mock email for testing
    console.log('⚠️ Real email failed, using mock email for testing');
    return sendMockEmail(email, resetToken, userName);
  }
};
